...
class ResultOnlineScreenState extends State<ResultOnlineScreen> {
            ...
            children: [
              Stack(
                children: [
                  ...
                  Align(
                    child: Text(
                      Utils.getTranslatedLabel(context, examResultKey),
                      style: setTextStyle(
              ...
              Column(
                children: [
                  ...
                  CustomRoundedButton(
                    ...
                    buttonTitle:
                        "${Utils.getTranslatedLabel(context, obtainedMarksKey)} :  ${result.totalObtainedMarks} / ${result.totalMarks}",
                    textSize: 14,
                    showBorder: true,
                  )
                ],
  ...
  Widget setTitleAndTotalQuestions({
    ...
    return Row(
      ...
      children: [
        Text(
          "$titleTxt ${Utils.getTranslatedLabel(context, marksKey)} ${Utils.getTranslatedLabel(context, questionsKey)}",
          style: setTextStyle(
            txtColor: Utils.getColorScheme(context).onBackground,
            txtSize: 16.0,
            ...
            children: [
              Column(
                children: [
                  ...
                  3.sizedBoxHeight,
                  Text(
                    Utils.getTranslatedLabel(context, correctAnswersKey),
                    style: setTextStyle(
              ...
              Column(
                children: [
                  ...
                  3.sizedBoxHeight,
                  Text(
                    Utils.getTranslatedLabel(context, incorrectAnswersKey),
                    style: setTextStyle(
                      txtColor: Theme.of(context)
                          .colorScheme
                          .onBackground
  ...
  Widget buildQuestionsAnalysisContainer({required Widget child}) {
    return Center(
      child: Container(
        ...
        decoration: BoxDecoration(
          color: Utils.getColorScheme(context).background,
          ...
          children: [
            Padding(
              ...
              child: Column(
                children: [
                  setTitleAndTotalQuestions(
                    titleTxt: Utils.getTranslatedLabel(context, totalKey),
